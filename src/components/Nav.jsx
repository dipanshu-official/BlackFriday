...
const Nav = () => {
    return (
        <div className='flex items-center justify-between max-w-7xl mx-auto'>
            <div className='flex justify-center items-center gap-6 txt-color py-4'>
                ...
                <div>
                    <NavLink to="/TrackOrder">
                        {({ isActive }) => (
                            <p className={`flex items-center gap-1 text-sm leading-5 ${isActive ? "text-[#FA8232]" : "text-[#5F6C72]"}`}>
                ...
                <div>
                    <p className='flex items-center gap-1 text-[#5F6C72] text-sm leading-5'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <NavLink to='/NeedHelp'>
                        {({ isActive }) => {
                            const textColor = isActive ? "text-[#FA8232]" : "text-[#5F6C72]";
                            return (
                                <p className={`flex items-center gap-1 ${textColor} text-sm leading-5`}>
                                    <svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                        ...
                                        stroke={isActive ? "#FA8232" : "currentColor"}
                                    >
                                        <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z"
                                            strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M11.25 11.25H12V16.5H12.75"
                                            strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M12.1875 7.875C12.1875 8.08211 12.0196 8.25 11.8125 8.25C11.6054 8.25 11.4375 8.08211 11.4375 7.875C11.4375 7.66789 11.6054 7.5 11.8125 7.5C12.0196 7.5 12.1875 7.66789 12.1875 7.875Z"
                                            fill={isActive ? "#FA8232" : "#191C1F"}
                                            strokeWidth="1.5" />
                                    </svg>
                                    Need Help
                                </p>
            ...
            <div>
                <p className='flex items-center gap-1 text-[#191C1F] text-lg leading-6'>
